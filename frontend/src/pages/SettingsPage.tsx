...
import { ServerSettingsPanel } from '../components/Desktop/ServerSettingsPanel';
import { BrowserComputerPanel } from '../components/Desktop/BrowserComputerPanel';
import { LogCenterPanel } from '../components/Desktop/LogCenterPanel';
import { PairingPanel } from '../components/Desktop/PairingPanel';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Section title="Server controls">
            <ServerSettingsPanel />
            <BrowserComputerPanel apiUrl={settings.apiUrl} apiKey={settings.apiKey} />
            <LogCenterPanel apiUrl={settings.apiUrl} apiKey={settings.apiKey} />
            <PairingPanel apiUrl={settings.apiUrl} apiKey={settings.apiKey} />
          </Section>
