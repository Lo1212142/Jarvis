...
class ProactiveConfig:
    ...
    # Proactive check-ins are opt-in and bounded to prevent surprise interruptions.
    voice_enabled: bool = False
    check_in_schedule: str = "0 10,15,19 * * *"
    ...
    notify_on_monitor_change: bool = True
...
class SystemPromptConfig:
    """Limits, persona style, and strategy for system-prompt assembly."""
    ...
    humor_style: str = "dry"
    sarcasm_level: str = "light"
    predictive_suggestions: Optional[bool] = None
    max_predictive_suggestions: int = 2
    never_joke_about_sensitive_topics: bool = True
    jarvis_capability_guide_enabled: bool = False
    jarvis_capability_guide_max_chars: int = 12000
